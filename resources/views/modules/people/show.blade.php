    ...
    <div class="row">
        <div class="col-12">
            <x-adminlte-card title="{{ $table_title }} " theme="default" icon="fas fa-sm fa-user-alt" collapsible>
                ...
                <x-adminlte-input name="country" label="Country" fgroup-class="row" label-class="col-md-2 control-label" igroup-class="col-md-10" value="{{ \App\Helpers\Helper::getCountryByCca2($data->country)->name }}" readonly/>
